...
func (c *ChannelGraph) sourceNode(nodes *bolt.Bucket) (*LightningNode, error) {
...
func (c *ChannelGraph) deleteLightningNode(nodes *bolt.Bucket,
...
func (c *ChannelGraph) pruneGraphNodes(nodes *bolt.Bucket,
